...
Как и в случае [обычного параметра по имени](https://scalabook.gitflic.space/docs/scala/methods/by-name-parameter), 
аргумент контекстного параметра `ev` оценивается по требованию. 
