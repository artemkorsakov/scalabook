...
[Функциональное программирование - FP](https://scalabook.gitflic.space/docs/scala/fp/what-is-fp) -
...
- [не использовать `null`](https://scalabook.gitflic.space/docs/scala/types#nothing-%D0%B8-null)
...
[Функция высшего порядка (_Higher-Order Function_ - HOF)](https://scalabook.gitflic.space/docs/scala/functions/hofs)
...
с помощью [анонимных функций](https://scalabook.gitflic.space/docs/scala/functions/anonymous) или функциональных литералов, 
