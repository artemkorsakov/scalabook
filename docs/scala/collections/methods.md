...
В главе [Анонимные функции](https://scalabook.gitflic.space/docs/scala/functions/anonymous) представлена более подробная информация 
...
в [соответствующей главе](https://scalabook.gitflic.space/docs/scala/fp).
...
> Более подробную информацию можно найти в разделе [Взаимодействие с Java](https://scalabook.gitflic.space/docs/scala/with_java).
