...
Рабочие листы похожи на [сеанс REPL](https://scalabook.gitflic.space/docs/scala/repl) и имеют поддержку редактора 1-го класса: 
...
Также обратите внимание, что worksheet не имеют [точек входа в программу](https://scalabook.gitflic.space/docs/scala/methods/main-methods). 
