...
import typeclass.monad.Divisible.{conquer, divide}
...
trait DivisibleLaw extends DivideLaw:
  def checkDivideLaw[F[_]: Divisible: Runner1, A, B, C](
    ...
    assertEquals(divide(fa1, conquer)(delta), fa1, "rightIdentity")
    assertEquals(divide(conquer, fa1)(delta), fa1, "leftIdentity")
