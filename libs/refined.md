...
При этом отброшена потенциально полезная информация об ограничениях этого `String`.
...
На решение этой проблемы брошены колоссальные ресурсы: пишутся тесты, команда QA
